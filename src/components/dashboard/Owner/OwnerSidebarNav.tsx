...
import { ownerMainMenuItems } from "@/constants/OwnerSideNavItems";
import { ownerGeneralItems } from "@/constants/SharedSideNavItems";
...
export const OwnerSidebarNav = ({ onCloseSheet }: OwnerSidebarNavProps) => {
