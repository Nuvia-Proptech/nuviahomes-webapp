...
export const KYCForm = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 sm:px-4 px-1 font-publicSans">
      <div className="mb-10 left-center">
        <h1 className="text-4xl font-bold mb-3 font-urbanist text-textColorDark">Become an Agent or Owner</h1>
        ...
        <div className="mt-10 max-w-6xl mx-auto px-2">
          ...
          <div className="md:hidden flex flex-col items-center mb-4">
            <span className="text-[10px] font-bold uppercase tracking-wider text-primaryColorMain">
              Step {step} of 7
            </span>
        ...
        {step === 1 && (
          <Card className="rounded-2xl border-none shadow-lg bg-white overflow-hidden ">
            ...
            <CardContent className="space-y-6 sm:pt-8 px-2 sm:px-6">
              {/* Role Selection */}
              <div className="bg-primaryColorMain/5 p-6 rounded-xl border border-primaryColorMain/10 mb-6 px-2 sm:px-6">
                <Label className="text-textColorDark text-base font-bold mb-4 block">I am applying to be a:</Label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${watchRole === 'agent' ? 'border-primaryColorMain bg-white shadow-md' : 'border-neutralColor-200 hover:border-primaryColorMain/50 bg-transparent'}`}>
                    <input 
                      type="radio" 
                      value="agent" 
                      className="h-5 w-5 text-primaryColorMain border-neutralColor-700 focus:ring-primaryColorMain mr-4 accent-primaryColorMain" 
                  ...
                  <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${watchRole === 'owner' ? 'border-primaryColorMain bg-white shadow-md' : 'border-neutralColor-200 hover:border-primaryColorMain/50 bg-transparent'}`}>
                    <input 
                      type="radio" 
                      value="owner" 
                      className="h-5 w-5 text-primaryColorMain border-neutralColor-700 focus:ring-primaryColorMain mr-4 accent-primaryColorMain" 
                ...
                {errors.applyingAs && <p className="text-red-500 text-xs mt-2">Please select a role.</p>}
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="fullName" className="text-textColor text-sm font-semibold">Full Legal Name</Label>
                  <Input id="fullName" className="rounded-xl border-neutralColor-700 focus:ring-primaryColorMain focus:border-primaryColorMain p-3 h-12" {...register("fullName", { required: true })} placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="dob" className="text-textColor text-sm font-semibold">Date of Birth</Label>
                  <Input id="dob" type="date" className="rounded-xl border-neutralColor-700 focus:ring-primaryColorMain focus:border-primaryColorMain p-3 h-12" {...register("dob", { required: true })} />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 w-full">
                  ...
                  <Select onValueChange={(val: string) => register("gender").onChange({ target: { value: val, name: "gender" } })}>
                    <SelectTrigger className="w-full rounded-xl border-neutralColor-700 focus:ring-primaryColorMain h-12">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="nationality" className="rounded-xl border-neutralColor-700 focus:ring-primaryColorMain p-3 h-12" {...register("nationality", { required: true })} placeholder="e.g. Nigerian" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="residentialAddress" className="text-textColor text-sm font-semibold">Residential Address</Label>
                <Input id="residentialAddress" className="rounded-xl border-neutralColor-700 focus:ring-primaryColorMain p-3 h-12" {...register("residentialAddress", { required: true })} placeholder="123 Main St, City, Country" />
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-6 sm:pt-8 px-2 sm:px-6">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(val: string) => register("idType").onChange({ target: { value: val, name: "idType" } })}>
                  <SelectTrigger className="w-full rounded-xl border-neutralColor-700 h-12">
              ...
              <div className="space-y-4">
                ...
                <label className="border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center bg-gray-50 border-neutralColor-700/50 hover:bg-primaryColorMain/5 hover:border-primaryColorMain transition-all cursor-pointer relative overflow-hidden group">
                  {watch("idFront")?.[0] ? (
                    <>
                      <img 
                      ...
                      <div className="z-10 bg-white/90 p-2 rounded-lg shadow-sm">
                        <p className="text-xs font-bold text-primaryColorMain flex items-center">
                    ...
                    <>
                      <div className="w-12 h-12 bg-primaryColorMain/10 rounded-full flex items-center justify-center mb-4">
                        <Upload className="h-6 w-6 text-primaryColorMain" />
                      </div>
                      <p className="text-sm text-textColor flex flex-col items-center">
                        <span className="font-bold text-primaryColorMain mb-1">Click to upload</span>
          ...
          <Card className="rounded-2xl border-none shadow-lg bg-white overflow-hidden">
            ...
            <CardContent className="space-y-6 sm:pt-8 px-2 sm:px-6">
              ...
              <div className="space-y-2">
                ...
                <label className="border-2 border-dashed rounded-2xl p-10 flex flex-col items-center justify-center bg-gray-50 border-neutralColor-700/50 hover:bg-primaryColorMain/5 hover:border-primaryColorMain transition-all cursor-pointer relative overflow-hidden group">
                   {watch("addressProof")?.[0] ? (
                    <div className="z-10 flex flex-col items-center">
                       {watch("addressProof")[0].type.startsWith('image/') ? (
                          ...
                          <div className="absolute inset-0 bg-primaryColorMain/5 w-full h-full" />
                       )}
                      ...
                      <p className="z-20 text-xs text-primaryColorMain font-bold mt-2">Click to change</p>
                    </div>
                  ) : (
                    <>
                      <div className="w-12 h-12 bg-primaryColorMain/10 rounded-full flex items-center justify-center mb-4">
            ...
            <CardContent className="space-y-6 sm:pt-8 px-2 sm:px-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-col items-center justify-center space-y-6 py-6">
                  <label className="w-56 h-56 rounded-full bg-secondaryColor border-2 border-dashed border-primaryColorMain/30 flex items-center justify-center overflow-hidden relative group cursor-pointer hover:border-primaryColorMain hover:shadow-lg transition-all">
                     {watch("selfie")?.[0] ? (
                        <img 
                        ...
                        <>
                          <div className="absolute inset-0 bg-primaryColorMain/0 group-hover:bg-primaryColorMain/5 transition-colors duration-300" />
                          <Upload className="h-14 w-14 text-primaryColorMain/40 group-hover:text-primaryColorMain transition-colors duration-300" />
                          <div className="absolute bottom-10 text-xs font-bold text-textColorFaded group-hover:text-primaryColorMain">Tap to upload</div>
                        </>
                     )}
        ...
        {step === 6 && (
          <Card className="rounded-2xl border-none shadow-lg bg-white overflow-hidden">
            ...
            <CardContent className="space-y-6 sm:pt-8 px-2 sm:px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="registrationNumber" className="text-textColor text-sm font-semibold">Registration Number</Label>
                  <Input id="registrationNumber" className="rounded-xl border-neutralColor-700 p-3 h-12" {...register("registrationNumber")} placeholder="RC-123456" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="businessAddress" className="text-textColor text-sm font-semibold">Business Address</Label>
                  <Input id="businessAddress" className="rounded-xl border-neutralColor-700 p-3 h-12" {...register("businessAddress")} placeholder="456 Business Way" />
                </div>
              </div>
              <div className="space-y-2">
                <Label className="text-textColor text-sm font-semibold">Certificate of Incorporation</Label>
                <label className="border-2 border-dashed rounded-xl p-6 flex items-center justify-center bg-gray-50 border-neutralColor-700/50 hover:bg-primaryColorMain/5 hover:border-primaryColorMain transition-all cursor-pointer relative">
                   {watch("incorporationCert")?.[0] ? (
                      <div className="flex items-center text-primaryColorMain font-semibold">
                      ...
                      <div className="flex items-center">
                        <Upload className="h-6 w-6 text-primaryColorMain mr-3" />
                        <span className="text-sm text-textColor font-medium">Upload Certificate</span>
                      </div>
                   )}
                  <input type="file" className="hidden" accept="application/pdf,image/*" {...register("incorporationCert")} />
                </label>
              </div>
              <div className="space-y-2">
