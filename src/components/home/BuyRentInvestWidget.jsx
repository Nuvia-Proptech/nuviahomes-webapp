...
export default function BuyRentInvestWidget({widgetStyle, searchText}) {
  return (
    <div className={`${widgetStyle}`}>
      ...
      {/*  */}
      <div className="skewed overflow-hidden flex justify-between text-lg text-black max-w-7xl mx-auto z-50">
        <div className="border-r border-white/35 bg-[#DFE6E7] h-[65px] w-full flex flex-col justify-center px-2">
