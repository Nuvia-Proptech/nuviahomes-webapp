...
export default function BuyRentInvestWidget({widgetStyle, searchText}) {
  return (
    <div className={`${widgetStyle}`}>
      ...
      {/*  */}
      <div className="skewed overflow-hidden flex justify-between text-lg bg-white text-black max-w-7xl mx-auto z-50">
        <div className="border-r border-black h-[65px] w-full flex flex-col justify-center px-2">
        ...
        <div className="h-[65px] w-full flex flex-col justify-center items-center px-2">
