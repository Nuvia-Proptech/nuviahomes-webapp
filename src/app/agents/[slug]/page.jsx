        ...
        <div className="flex gap-10">
          ...
          <div className="flex gap-10 w-full">
            <div className="w-1/2 pr-8">
              ...
              <p className="text-20 mb-2">Real Estate Agent/Broker</p>
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  <div>
                    ...
                    <p>{agent.contacts.find((c) => c.type === "Mobile")?.value}</p>
                    <p>{agent.contacts.find((c) => c.type === "Office")?.value}</p>
                  </div>
                  <div>
                    <p className="text-20">Email</p>
                    <p>{agent.contacts.find((c) => c.type === "Email")?.value}</p>
                    <p>{agent.contacts.find((c) => c.type === "WhatsApp")?.value}</p>
                  </div>
                </div>
                <div className="flex justify-between">
                  <div>
                  ...
                  <div>
                    ...
                    <p>{agent.contacts.find((c) => c.type === "Website")?.value}</p>
                  </div>
                </div>
              </div>
            </div>
